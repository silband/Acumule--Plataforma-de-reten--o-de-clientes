...
?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item"><a>Lançamento de pontos</a></li>
				<li class="breadcrumb-item active"><a>Individual</a></li>
			</ol>
			<!-- Fim Caminho -->
			<!-- Inicio Título da Página -->
			<h1 class="page-header">Lançamento de pontos individual</h1>
...
<?php include("app/ajudaformulario.php"); ?>
							...
							<div class="col-xl-10">
								...
								<div class="form-group row m-b-15">
									<label class="col-form-label-lg col-md-3">Valor da compra</label>
									<div class="col-md-9">
										<div class="row row-space-10">
											<div class="col-xs-11 mb-2 mb-sm-0">
