...
?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active"><a>Itens para Resgate</a></li>
			</ol>
			<!-- Fim Caminho -->
			<!-- Inicio Título da Página -->
			<h1 class="page-header">Cadastro de Itens para Resgate</h1>
				...
				<div class="col-xl-12">
					...
					<div class="panel panel-inverse" data-sortable-id="regular">
						...
						<div class="panel-heading">
							<h4 class="panel-title">Itens para Resgate</h4>
							...
							<div class="col-xl-10">
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<div class="row row-space-10">
											<div class="col-xs-11 mb-2 mb-sm-0">
												<input type="text" class="form-control" id="pontuacao" maxlength="20" placeholder="até 20 caracteres" />
											</div>
											<div class="col-xs-1 mb-2 mb-sm-0">
								...
								<!-- Fim Resumo -->
								<!-- Inicio Tipo de Resgate -->
								<div class="form-group row m-b-15">
									<label class="col-form-label-lg col-md-3">Tipo de Resgate</label>
									<div class="col-md-9">
										<div class="row row-space-10">
											<div class="col-xs-11 mb-2 mb-sm-0">
												<select class="form-control">
													<option>Produtos</option>
													<option>Vale Compras</option>
													<option>Cupons de desconto</option>
												</select>
											</div>
											<div class="col-xs-1 mb-2 mb-sm-0">
									...
									<table class="table table-striped table-bordered table-td-valign-middle">
										<thead>
											<tr>
												...
												<th class="text-nowrap" >Número de Pontos</th>
