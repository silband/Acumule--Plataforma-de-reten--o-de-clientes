...
?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active"><a>Filiais</a></li>
			</ol>
			<!-- Fim Caminho -->
...
<?php include("app/ajudaformulario.php"); ?>
							...
							<div class="col-xl-10">
								<!-- Inicio Nome da filial -->
								<div class="form-group row m-b-15">
									<label class="col-form-label-lg col-md-3">Nome da filial</label>
									<div class="col-md-9">
										<div class="row row-space-10">
											<div class="col-xs-11 mb-2 mb-sm-0">
												<input type="text" class="form-control" id="nomefilial" maxlength="40" placeholder="até 40 caracteres" />
											</div>
											<div class="col-xs-1 mb-2 mb-sm-0">
												<a href="#modal-nomefilial" data-toggle="modal" class="btn btn-teal btn-icon btn-circle btn-sm">
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<div class="row row-space-10">
											<div class="col-xs-11 mb-2 mb-sm-0">
												<input type="text" class="form-control" id="endereco" maxlength="100" placeholder="até 100 caracteres" />
											</div>
											<div class="col-xs-1 mb-2 mb-sm-0">
												<a href="#modal-endereco" data-toggle="modal" class="btn btn-teal btn-icon btn-circle btn-sm">
													<i class="fa fa-info"></i>
												</a>
											</div>
										</div>
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<div class="row row-space-10">
											<div class="col-xs-11 mb-2 mb-sm-0">
												<input type="text" class="form-control" id="email" maxlength="40" placeholder="até 40 caracteres" />
											</div>
											<div class="col-xs-1 mb-2 mb-sm-0">
									...
									<table class="table table-striped table-bordered table-td-valign-middle">
										<thead>
											<tr>
												...
												<th class="text-nowrap" >Responsãvel</th>
